...
Toggle features from your userscript manager's menu (Tampermonkey ▸ the wavez.fm tab ▸ the ✓/✕ entries). Auto Woot and Auto Grab start **off**, everything else starts on.
